...
from sklearn.model_selection import train_test_split  ## makes the ml model learn datasets
from sklearn.linear_model import LinearRegression  ## learns (this is ml bot 1)
from sklearn.tree import DecisionTreeRegressor   ## bot 2
from sklearn.ensemble import RandomForestRegressor   ## bot 3

from sklearn.metrics import r2_score, mean_squared_error   #r2 score- comparison mean sq err- for err cal

import matplotlib.pyplot as plt # graph
import seaborn as sns #accuracy table
...
if __name__ == ("__main__"):
    datasets = [
        ('Dataset 1', 'D:/college work/coding/DATA SETS/AI proj/1.csv', clean_dataset1),
        ('Dataset 2', 'D:/college work/coding/DATA SETS/AI proj/2.csv', clean_dataset2),
        ('Dataset 3', 'D:/college work/coding/DATA SETS/AI proj/3.csv', clean_dataset3)
    ]
